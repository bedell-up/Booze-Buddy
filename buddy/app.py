...
# Define the get_db dependency function early in your code
def get_db():
    db = SessionLocal()
    try:
        yield db
...
class BoozeBuddy:
    def __init__(self):
        # Cocktail API setup
        self.api_base_url = "https://www.thecocktaildb.com/api/json/v2/"
        self.api_key = "961249867"  # Free tier key
...
# Public endpoint for checking health and version
@app.get("/health")
def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "message": "Booze Buddy API is running"
    }
